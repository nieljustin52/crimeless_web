            ...
            <div class="copyright-area">
                <div class="container">
                    <div class="copyright-content">
                        <div class="row">
                            <div class="col-sm-6">
                                <p class="copyright-text"> <a href="#">CrimeLess</a></p>
                            </div>
                            <div class="col-sm-6">
                               <p class="copyright-text"> <a href="#">By Nichole Ann Dinauanao | 161103044</a></p>
                            </div>
                        </div>
                    </div>
                </div>
