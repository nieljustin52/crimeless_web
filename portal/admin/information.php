            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li >
                            <a href="agency.php"><i class="fa fa-user-md"></i> <span>Stations</span></a>
                        </li>
                        <li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0">Generoso Gastardo</h3>
                                        ...
                                        <div class="col-md-7">
                                            <ul class="personal-info">
                                                ...
                                                <li>
                                                    ...
                                                    <span class="text"><a href="#">gastardogene88@gmail.com</a></span>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    ...
                                                    <span class="text">F.C.T Cebu City</span>
                                                </li>
