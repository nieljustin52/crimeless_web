                ...
                $sql = "INSERT INTO agency(name,phone,email,username,password,address,joined,agency_id,tmp,file)VALUES('$name','$phone','$email','$personincharge','$username','$password','$state','$address','$joined','agency_id','$tmp')";
