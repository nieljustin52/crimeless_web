                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        ...
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info text-right">
                                <h3><?php echo $row['total'] ;?></h3>
                                <span class="widget-title2">Civilians <i class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    <?php } ?>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        ...
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info text-right">
                                <h3><?php echo $row['total'] ;?></h3>
                                <span class="widget-title3">Stations <i class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    <?php } ?>
                    </div>
					...
					<div class="col-12 col-md-6 col-lg-8 col-xl-8">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title d-inline-block">Stations</h4> <a href="agency.php" class="btn btn-primary float-right">View all</a>
							</div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4">
                        <div class="card member-panel">
							<div class="card-header bg-white">
								<h4 class="card-title mb-0">Civilians</h4>
							</div>
                            <div class="card-body">
			                 	<?php
